...
void main()
{
    ...
    gl_FragColor =
        vec4(1.0 - ((outColor.r * 1.3 * m * m * COLOR_FACTOR + grey * (1.1 - COLOR_FACTOR) - 0.15)) * brightness * m,
             1.0 - ((outColor.g * 1.0 * COLOR_FACTOR + grey * (1.1 - COLOR_FACTOR) - 0.15)) * brightness * m,
             1.0 - ((outColor.b * 0.7 * COLOR_FACTOR + grey * (1.1 - COLOR_FACTOR) - 0.15)) * brightness * m,
             1.0);
}